...
This function is an event handler that resizes all of the panes in Internet Explorer 6.  The
...
This function resizes the menu pane whenever the Internet Explorer 6 window is resized.  This
...

{
  if (navigator.appName == "Microsoft Internet Explorer")
  {
    ...
    if (element != null)
      element.style.height = (document.body.clientHeight - 18) + "px";
  }
